...
//
exports.getQuestionsForQuiz = functions.https.onRequest((request, response) => {
  ...
  response.send(questionsList);

});



exports.saveQuestionResult = functions.https.onRequest((request, response) => {

    let {userId,dataToSave} = request.body;
